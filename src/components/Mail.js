    ...
    return (
        <div className="mt-6 w-full">
            <form className="flex flex-col" method="post" onSubmit={CreateMail()}>
                ...
                <button className="w-auto text-xl h-12 m-auto px-5 duration-200 bg-purple-300 rounded-lg text-white-light hover:underline hover:bg-purple-200 hover:translate-x-0.5 hover:-translate-y-0.5 hover:shadow-2xl" id="submit-button" type='submit' value='Send'>Submit</button>     
            </form>
        </div>
    )
}
