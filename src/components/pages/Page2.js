...
function secondPage(){
    return (
        <div className="relative w-full pb-40 lg:h-screen m-0 bg-white-ivory flex flex-col">

            <div className='flex flex-col lg:flex-row pt-4 mx-10 lg:justify-evenly'>
                ...
                <div className="w-full sm:w-7/12 lg:w-2/5 h-fit mx-auto"> {/*!center the image */}
                    <img className='mt-16' src={logo} alt="NTNU logo"/> 
                </div>
            </div>

            <div className="flex flex-col lg:flex-row-reverse pt-4 mx-10 sm:mt-16 lg:mt-20 justify-evenly">
                <div className="w-full lg:w-2/5 h-fit">
