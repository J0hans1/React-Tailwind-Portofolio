    ...
    return (
        <div className="relative w-full h-fit m-0 bg-gradient-to-b from-purple-100 to-sand-200">
            ...
            <div className="flex flex-col items-center mx-5 sm:mx-40 pb-10">
                <Project name="Ontap" desc="A group project in the course webtechnologies at NTNU. The webpage is completely vanilla; written in ES6, CSS3 and HTML5. The customer of the webpage was a interests-group for brewing enthusiasts in Online student organization, called Ontap. The contributors to this project was: sand-200er G Slinning, Markus A R Johansen, Benjamin Fogalele, Oskar Nesheim, Naqibullah Rahimi" src="1" github="https://github.com/J0hans1/Ontap"/>
